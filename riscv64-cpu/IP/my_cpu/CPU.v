...
always @(*) $display("fetch_o_commit = %d",fetch_o_commit);
...
always @(*) $display("fetch_o_commit = %d",regD_o_commit);
...
always @(*) $display("regM_o_commit = %d",regM_o_commit);
...
always @(*) $display("regM_o_commit = %d,regW_o_commit = %d",regM_o_commit,regW_o_commit);
